...
function AuthForm({ mode }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            if (isSignup) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/auth/register', {
                    method: 'POST',
                    body: {
                        email: trimmedEmail,
                        password
            ...
            const loginResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/auth/login', {
                method: 'POST',
                body: {
                    email: trimmedEmail,
                    password,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c929906c._.js.map