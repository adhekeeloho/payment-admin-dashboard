...
"[project]/src/app/(auth)/otp/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OtpPage() {
    ...
    const [otp, setOtp] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(Array.from({
        length: 6
    }, ()=>''));
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            ...
            const verifyResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/auth/otp/verify', {
                method: 'POST',
                body: {
                    email: pending?.email,
                    code,
    ...
    const handleResend = async ()=>{
        try {
            const pendingRaw = localStorage.getItem('payflow-pending');
            const pending = pendingRaw ? JSON.parse(pendingRaw) : null;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/auth/otp/request', {
                method: 'POST',
                body: {
                    email: pending?.email
                }
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            ...
                            ' ',
                            pendingEmail ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d5eaa3b._.js.map