...
// Validate ../../../src/app/(dashboard)/oversight/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/oversight">> = Specific
  const handler = {} as typeof import("../../../src/app/(dashboard)/oversight/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
